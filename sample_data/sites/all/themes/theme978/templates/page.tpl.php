...
<?php if ( !theme_get_setting( 'theme978_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme978_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-1"> <!-- Sticky menu wrapper -->
				<div class="container-12">
					<div class="grid-12">
						<div class="col1">
							<!-- Logo -->
			...
			<?php if ( $page['slider_content'] || $page['banner_content']) :?>
			<div class="header-section-2">
				<div class="container-12">
					<div class="grid-12">
						<div id="slider-content" class=" <?php if ( $page['banner_content'] ) : print 'grid-8 alpha'; endif; ?>">
							<!-- Slider content -->
						...
						<?php if ( $page['banner_content'] ) : ?>
							<!-- Banner content -->
							<aside id="banner-content" class="grid-4 omega">
								<?php print render( $page['banner_content'] ); ?>
							</aside>
						<?php endif; ?>
					</div>
				</div>
			...
			<?php if ( $page['header_bottom'] ) : 
				theme978_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme978_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['content_top'] ) : 
				theme978_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				theme978_region_suffix ( 'content_top' );
			endif; ?>
			...
			<?php if ( $page['content_bottom'] ) : 
				theme978_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				theme978_region_suffix ( 'content_bottom' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) : 
				theme978_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				theme978_region_suffix ( 'footer_top' );
			endif; ?>
